...
const AVATARS = [
  ...
  { emoji: '🐻', label: 'Ayı', bg: 'from-orange-300 to-amber-600' },
  { emoji: '🦊', label: 'Tilki', bg: 'from-orange-400 to-red-500' },
  { emoji: '🐼', label: 'Panda', bg: 'from-gray-300 to-gray-500' },
  { emoji: '🐨', label: 'Koala', bg: 'from-gray-400 to-blue-400' },
  { emoji: '🦄', label: 'Unicorn', bg: 'from-pink-400 to-purple-500' },
  { emoji: '🐶', label: 'Köpek', bg: 'from-yellow-300 to-amber-500' },
  ...
  { emoji: '🌈', label: 'Gökkuşağı', bg: 'from-red-400 to-blue-500' },
  { emoji: '\u2B50', label: 'Yıldız', bg: 'from-yellow-400 to-orange-400' },
  { emoji: '🌙', label: 'Ay', bg: 'from-indigo-400 to-purple-600' },
  ...
  { emoji: '🦸\u200D\u2642\uFE0F', label: 'Kahraman', bg: 'from-red-500 to-orange-500' },
  { emoji: '🦸\u200D\u2640\uFE0F', label: 'Kahraman', bg: 'from-purple-500 to-pink-500' },
]
